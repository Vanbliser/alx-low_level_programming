...
int main(void)
{
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(NULL, 1, 1);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	print = print_dlistint(NULL);
	if (print == 0)
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(&a, 0, 0);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(&h, 1, 1);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(&h, 2, 2);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(&b, 0, 0);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(&c, 1, 1);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(&c, 2, 2);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(&d, 0, 0);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(&d, 1, 1);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(&d, 2, 2);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	r = insert_dnodeint_at_index(&d, 3, 3);
	if (r == NULL)
		printf("IT RETURNED NULL, BECAUSE IT FAILED\n");
	else
		printf("SUCCEEDED\n");
	...
	print = print_dlistint_rev(head);
	if (print == 0)
		printf("NULL\n");
	free_dlistint(head);
	head = NULL;

	printf("\n======LENGTH OF 8, ADD AT INDEX 8======================\n\n");
	head = NULL;
	...
	if (print == 0)
		printf("NULL\n");
	printf("-----------------\n");
	insert_dnodeint_at_index(&head, 8, 8);
	print = print_dlistint_rev(head);
	if (print == 0)
		printf("NULL\n");
	free_dlistint(head);
